...
export const ScrollStackItem: React.FC<ScrollStackItemProps> = ({
  ...
  <div
    className={`scroll-stack-card relative w-full h-80 my-8 p-12 rounded-[40px] shadow-[0_0_30px_rgba(0,0,0,0.1)] box-border origin-top will-change-transform transform-gpu ${itemClassName}`.trim()}
    style={{
...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    cardsRef.current.forEach((card, i) => {
      ...
      if (hasChanged) {
        ...
        // Apply transforms directly without additional requestAnimationFrame
  ...
  const handleScroll = useCallback(() => {
    ...
    scrollTimeoutRef.current = setTimeout(() => {
      ...
      updateCardTransforms();
    }, 50); // Short timeout for responsive updates
  }, [updateCardTransforms]);
